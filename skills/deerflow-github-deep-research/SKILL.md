---
name: deerflow-github-deep-research
description: (Ported from DeerFlow) Conduct multi-round deep research on any GitHub Repo. Use when users request comprehensive analysis, timeline reconstruction, competitive analysis, or in-depth investigation of GitHub. Produces structured markdown reports with executive summaries, chronological timelines, metrics analysis, and Mermaid diagrams. Triggers on Github repository URL or open source projects.
---

> **OpenClaw Port**: Ported from [DeerFlow](https://github.com/deer-flow/deer-flow). Original functionality preserved.

# DeerFlow GitHub Deep Research Skill
...
```bash
python /root/.openclaw/workspace/skills/deerflow-github-deep-research/scripts/github_api.py <owner> <repo> summary
python /root/.openclaw/workspace/skills/deerflow-github-deep-research/scripts/github_api.py <owner> <repo> readme
python /root/.openclaw/workspace/skills/deerflow-github-deep-research/scripts/github_api.py <owner> <repo> tree
```
...
Follow template in `/root/.openclaw/workspace/skills/deerflow-github-deep-research/assets/report_template.md`:
