...
description: (Ported from DeerFlow) Use this skill when the user uploads Excel (.xlsx/.xls) or CSV files and wants to perform data analysis, generate statistics, create summaries, pivot tables, SQL queries, or any form of structured data exploration. Supports multi-sheet Excel workbooks, aggregation, filtering, joins, and exporting results to CSV/JSON/Markdown.
---

> **OpenClaw Port**: Ported from [DeerFlow](https://github.com/deer-flow/deer-flow). Requires Python with duckdb and openpyxl.
...
```bash
python /root/.openclaw/workspace/skills/deerflow-data-analysis/scripts/analyze.py \
...
python /root/.openclaw/workspace/skills/deerflow-data-analysis/scripts/analyze.py \
  ...
  --output-file /path/to/output/filtered-results.csv
```
...
python /root/.openclaw/workspace/skills/deerflow-data-analysis/scripts/analyze.py \
  ...
  --output-file /path/to/output/monthly-trends.csv
```
...
```bash
python /root/.openclaw/workspace/skills/deerflow-data-analysis/scripts/analyze.py \
  --files /path/to/orders.csv /path/to/customers.xlsx \
  --action query \
...
- On first load, files are parsed and stored in a persistent DuckDB database under `/tmp/.data-analysis-cache/`
